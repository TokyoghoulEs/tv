...
#################
panel = input("""
Beispiel PanelName:Port = iptvturkiye.xyz:8080\n
	\33[1mBitte Portal auswählen.. ? \n\n
...
if panel=="1":
    ...
    print(feyzo)
    uzmanmodu="açık"
    print("Expertenmodus eingeschaltet, nicht Beenden wenn es fehlschlägt") 
    panel = input("""
Beispiel PanelName:Port = iptvturkiye.xyz:8080\n
	\33[1mBitte Panel Name eingeben.. ? \n\n
Panel:Port=\33[0m\33[31m\33[1m""")
macturu=input("""
\33[1mMac Kombinationstyp auswählen...?\33[0m
\33[33mFür aufeinanderfolgende aufsteigende Macs = \33[31m1
\33[33mFür zufällige Macs   = \33[31m2

\33[0m\33[1mMac Kombinationstyp=\33[31m""")
if macturu=="":
	macturu="2"
#################
#print("\nSo scannen Sie Panel:Port=\33[1m\33[31m" + panel +"\33[0m\n") 
#D4:CF:F9
#MacCombo="33:44:CF:4"
MacCombo="00:1A:79:"
#MacCombo="10:27:be:"
subprocess.run(["clear", ""])
print(feyzo) 
Macs = input("\33[0m\nStandart Mac verwenden? \nAntwort \33[1m\33[34mJa = Enter\33[0m Erweitert = e \33[1m\33[32mNein = 0\33[0m Schreiben!! =") 
if Macs=="1":
	macSayisi=1#int(input("Anzahl der anzurufenden Macs =")) 
	ozelmac=input("Benutzerdefinierte Mac =")
if  Macs=="0":
	dmac=input("""
Standard-Mac-Typ
	1= 00:1A:79:
	...
	if dmac=="1":
		MacCombo="00:1A:79:"
		Macs = input("\33[0m\nStandart Mac verwenden? \nAntwort \33[1m\33[34mJa = Enter\33[0m Schreiben!! =") 
	...
	if dmac=="4":
		MacCombo=input("Die ersten drei Übereinstimmungstypen Schreiben...")
		Macs = input("\33[0m\nMac verwenden? \nAntwort \33[1m\33[34mJa = Enter\33[0m Schreiben!! =") 


if Macs[:1]=="e" or Macs[:1]=="E" :
    Seri=input("Beispiel="+MacCombo+"\33[31m5\33[0m\nBeispiel="+MacCombo+"\33[31mFa\33[32m\num ein oder zwei Zeichen erweitern!!!\33[0m\n\33[1m"+MacCombo+"\33[31m")
    Seri=Seri[:2]
...
#	try:
	...
	cpm=(time.time()-cpm)
	cpm=(round(60/cpm))
	print ("\33[96m🅧-🅟🅡🅞  Total ➤"+total+"    \33[33m Hit ➤" + str(hit)+ "   \33[94m Cpm ➤" +str(cpm)+"  \n\33[0m" +mac+" \33[32m" +panel)
	cpm=time.time()
